...
class UserPreferencesTestCase(TestCase):
    def setUp(self):
        ...
        self.customUser = CustomUser.objects.create(username='testuser', email='test@example.com', preferences = "True", last_login=timezone.now())
        self.client = Client()
    ...
    def test_create_custom_user(self):
        ...
        custom_user = CustomUser.objects.create(
            ...
            last_login=timezone.make_aware(timezone.datetime(2022, 1, 1)),  # Set last_login to a specific datetime for demonstration
        )
        ...
        self.assertEqual(retrieved_custom_user.last_login, timezone.make_aware(timezone.datetime(2022, 1, 1)))
    ...
    def test_set_preferences_valid_data_authenticated_update(self):
        ...
        fq = RequestFactory()
        custom_user = CustomUser.objects.create(username='test', email = 'test@test.com', preferences = "True")
    ...
    def test_set_preferences_invalid_data_authenticated_set(self):
        ...
        custom_user = CustomUser.objects.create(username='test', email = 'test@test.com', preferences = "False")
    ...
    def test_preferences_authenticated_with_preferences(self):
        ...
        self.assertEqual(response.template_name, 'users/preferences.html')
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.context_data['preferences']['phone_number'], '1234567890')
        self.assertEqual(response.context_data['preferences']['address'], 'Test Address')
    ...
    def test_update_custom_user_existing(self):
        ...
        self.assertTrue(custom_user.last_login > timezone.now() - timezone.timedelta(seconds=1))
